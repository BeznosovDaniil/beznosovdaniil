<p align="center">
  <img src="banner.png" alt="Daniil Beznosov — Junior QA Engineer" />
</p>

## 🧑‍💻 Обо мне

Я — Безносов Даниил, начинающий Software Tester/QA Engineer. Мой путь в мир тестирования начался в 2025 году. Обучался самостоятельно + курсы Stepik, курсы по ручному и нагрузочному тестированию. Мне интересно разбираться в том, как устроены системы, находить слабые места и помогать делать продукт более стабильным и удобным для пользователей. 
## 🛠 Мои навыки
...
- Email: **beznosoffdaniil@yandex.ru**
